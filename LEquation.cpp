    ...
    four_equation::four_equation ( double a, double b, double c, double d, double e ) {
            ...
            four_equation:: SolveP4De(double *x, double b, double c, double d)
            {
               if( fabs(c)<1e-14*(fabs(b)+fabs(d)) ) return four_equation::SolveP4Bi(x,b,d);
                ...
                int res3 = Object.SolveP3(x, 2*b, b*b-4*d, -c*c);
                if( res3>1 )
                {
...
int main()
{
    ...
    if (a==0) {
        ...
        one_equation One_E(b,c);
        One_E.print_P1(x,b,c);

        two_equation Two_E(b,c,d);
        Two_E.print_P2(x,b,c,d);

        three_equation Three_E (b,c,d,e);
        Three_E.print_P3(x,b,c,d,e);
              }
    }
    if (R=='f') {
    ...
    {
    one_equation One_E(b,c);
    One_E.print_file_P1(x,b,c);

    two_equation Two_E(b,c,d);
    Two_E.print_file_P2(x,b,c,d);

    three_equation Three_E (b,c,d,e);
    Three_E.print_file_P3(x,b,c,d,e);
    }
