...
class one_equation
{
    ...
    public:
        ...
        void print_file_P1 (double *x, double a, double b);
        ~one_equation();
};
class two_equation
{
    ...
    public:
        ...
        void print_file_P2 (double *x, double a, double b, double c);
        ~two_equation();
};
...
class three_equation
{
    ...
    public:
        ...
        void print_file_P3 (double *x, double a, double b, double c, double d);
        ~three_equation();
};
...
class four_equation
{
    ...
    public:
        ...
        void print__file_P4 (double *x, double a, double b, double c, double d, double e);
        ~four_equation();
};
